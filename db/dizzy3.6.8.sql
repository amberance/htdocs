...
--
-- Host: localhost:8889
-- Generation Time: Aug 10, 2022 at 05:15 AM
...
CREATE TABLE `i_user_uploads` (
  ...
  `upload_time` int(13) DEFAULT NULL,
  `ip` longtext,
  `upload_type` enum('wall','profile','product') NOT NULL DEFAULT 'wall'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `i_svg_icons`
  MODIFY `icon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=175;

--
-- AUTO_INCREMENT for table `i_users`
--
ALTER TABLE `i_users`
  MODIFY `iuid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

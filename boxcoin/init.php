...
function bxc_checkout($settings) {
    ...
    $cryptocurrencies = [['btc', 'Bitcoin'], ['eth', 'Ethereum'], ['doge', 'Dogecoin'], ['usdt', 'Tether'], ['usdt_tron', 'Tether'], ['usdc', 'USD Coin'], ['busd', 'Binance USD'], ['bnb', 'BNB'], ['shib', 'Shiba Inu'], ['ltc', 'Litecoin'], ['link', 'Chainlink'], ['bat', 'Basic Attention Token'], ['algo', 'Algorand'], ['bch', 'Bitcoin Cash']];
    ...
    for ($i = 0; $i < count($cryptocurrencies); $i++) {
        $cryptocurrency_code = $cryptocurrencies[$i][0];

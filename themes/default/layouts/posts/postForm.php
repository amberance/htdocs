<div class="i_postFormContainer">
    ...
    <div class="i_warning_point_two"><?php echo filter_var($LANG['must_be_start_with_number'], FILTER_SANITIZE_STRING);?></div>
...
<div class="i_uploading_not"><?php echo filter_var($LANG['uploading_please_wait'], FILTER_SANITIZE_STRING);?></div>
...
<!--/UPLOADED IMAGES OR VIDEOS-->
<!--Mention Results-->
<div class="mentions_list" style="display:none;"></div>
<!--/Mention Results-->

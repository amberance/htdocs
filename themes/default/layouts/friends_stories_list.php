<div class="th_middle">
   ...
   <div class="live_item transition">
    <div class="stories_page_title flex_ tabing_non_justify"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('154'));?><?php echo filter_var($LANG['all_friends_stories'], FILTER_SANITIZE_STRING);?></div> 
</div>
   <div class="my-stories-wrapper flex_ mystoriesstyle" id="story-view" style="padding-top:30px;">  
            <?php 

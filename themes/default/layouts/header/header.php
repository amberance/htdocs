<div class="header">
   <div class="i_header_in">
     ...
     <div class="i_header_right">
        ...
        <?php if($logedIn == 1){?>
            <div class="i_header_btn_item topPoints transition ownTooltip" data-label="<?php echo filter_var($LANG['get_point_and_point_balance'], FILTER_SANITIZE_STRING);?>" id="topPoints" data-type="topPoints">
              <div class="i_h_in"> 
                <?php echo html_entity_decode($iN->iN_SelectedMenuIcon('40'));?>
              </div>
            </div>
            <div class="i_header_btn_item transition shopi ownTooltip" data-label="<?php echo filter_var($LANG['marketplace'], FILTER_SANITIZE_STRING);?>">
            <a href="<?php echo filter_var($base_url, FILTER_VALIDATE_URL).'marketplace?cat=all';?>">
              <div class="i_h_in"> 
                <?php echo html_entity_decode($iN->iN_SelectedMenuIcon('158'));?>
              </div>
            </a>
            </div> 
            <div class="i_header_btn_item topMessages transition ownTooltip" data-label="<?php echo filter_var($LANG['messenger'], FILTER_SANITIZE_STRING);?>" id="topMessages" data-type="topMessages">
                <div class="i_h_in">
            ...
            <div class="i_header_btn_item topNotifications transition ownTooltip" data-label="<?php echo filter_var($LANG['notifications'], FILTER_SANITIZE_STRING);?>" id="topNotifications" data-type="topNotifications">
                <div class="i_h_in">
...
<audio id="notification-sound-coin" class="sound-controls" preload="auto">
    <source src="<?php echo filter_var($base_url, FILTER_VALIDATE_URL);?>themes/<?php echo filter_var($currentTheme, FILTER_SANITIZE_STRING);?>/mp3/coin.mp3" type="audio/mpeg">
</audio>
<audio id="notification-sound-call" class="sound-controls" preload="auto">
    <source src="<?php echo filter_var($base_url, FILTER_VALIDATE_URL);?>themes/<?php echo filter_var($currentTheme, FILTER_SANITIZE_STRING);?>/mp3/call.mp3" type="audio/mpeg">
</audio> 
<?php }?>

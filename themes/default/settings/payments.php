    ...
    <div class="i_settings_wrapper_items"> 
       <div class="i_tab_container">   
           ...
           <div class="i_tab_header flex_">
               ...
               <div class="tab_item item_mobile"><?php echo filter_var($LANG['pay_type'], FILTER_SANITIZE_STRING);?></div> 
           </div>
           <!--/PAYMENTS TABLE HEADER-->
           <!---->
           <div class="i_tab_list_item_container">
            ...
            ?> 
                ...
                <div class="i_tab_list_item flex_">
                    <div class="tab_detail_item" style="max-width:50px;"><?php echo filter_var($paymentDataID, FILTER_SANITIZE_STRING);?></div>
                    ...
                    <div class="tab_detail_item item_mobile"><span class="flex_ tabing ty_<?php echo filter_var($paymentDataPaymentType,FILTER_SANITIZE_STRING);?>"><?php echo filter_var($PAYMENTTYPES[$paymentDataPaymentType], FILTER_SANITIZE_STRING);?></span></div> 
               </div>
               <!--/ITEM-->
            <?php }
               }else {

...
CREATE TABLE `i_user_payments` (
  ...
  `payment_option` enum('stripe','paypal','razorpay','iyzico','authorize-net','paystack','bitpay','coinpayment','mercadopago') NOT NULL DEFAULT 'stripe',

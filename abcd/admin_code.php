 ...
 * ==========================================================
 *
 * Admin area. © 2022 boxcoin.dev. All rights reserved.
 *
 */
...
function bxc_box_admin() { 
    ...
    if (!bxc_ve_box()) return;
?>
<div class="bxc-main bxc-admin bxc-area-transactions<?php if (bxc_is_rtl(bxc_language(true))) echo ' bxc-rtl'; ?>">
    <div class="bxc-sidebar">
        <div>
            <img class="bxc-logo" src="<?php echo bxc_settings_get('logo-admin') ? bxc_settings_get('logo-url', BXC_URL . 'media/logo.svg') : BXC_URL . 'media/logo.svg' ?>" />
            <img class="bxc-logo-icon" src="<?php echo bxc_settings_get('logo-admin') ? bxc_settings_get('logo-icon-url', BXC_URL . 'media/icon.svg') : BXC_URL . 'media/icon.svg' ?>" />
        </div>
        <div class="bxc-nav">
        ...
        <div class="bxc-bottom">
            ...
            <div class="bxc-mobile-menu">
                ...
                <div class="bxc-flex">
                    ...
                    <a class="bxc-btn-icon" href="https://boxcoin.dev/docs" target="_blank">

                ...
                <div class="i_post_u_images"> 
                            ...
                            if($VideofileData){
                                ...
                                if($VideofileExtension == 'mp4'){ 
                                    ...
                                    if($s3Status == 1){
                                        ...
                                        $VideofileTumbnailUrl = 'https://' . $s3Bucket . '.s3.' . $s3Region . '.amazonaws.com/' . $VideofilePath;
                                    }else if ($digitalOceanStatus == '1') {
                                        $VideofilePathUrl = 'https://' . $oceanspace_name . '.' . $oceanregion . '.digitaloceanspaces.com/' . $VideofilePath;
                                        $VideofileTumbnailUrl = 'https://' . $oceanspace_name . '.' . $oceanregion . '.digitaloceanspaces.com/' . $VideofilePath;
                                    }else{
                                        $VideofilePathUrl = $base_url . $VideofilePath;
                                        $VideofileTumbnailUrl = $base_url . $VideofilePath;
                                    }
                                    echo '
                    ...
                    echo '<div class="'.$container.'" id="lightgallery'.$userPostID.'">';
                        foreach($explodeFiles  as $dataFile){
                            ...
                            $fileUploadTumbnailPath = $fileData['upload_tumbnail_file_path'];
                            ...
                            if($fileExtension == 'mp4'){
                                ...
                                if($s3Status == 1){ 
                                    ...
                                    $filePathUrl = 'https://' . $oceanspace_name . '.' . $oceanregion . '.digitaloceanspaces.com/' . $fileData['upload_tumbnail_file_path'];
                                    $filePathTumbnailUrl = 'https://' . $oceanspace_name . '.' . $oceanregion . '.digitaloceanspaces.com/' . $fileData['upload_tumbnail_file_path'];
                                }else{ 

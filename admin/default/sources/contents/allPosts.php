...
<div class="i_contents_container">
    <div class="i_general_white_board border_one column flex_ tabing__justify">
        ...
        <tr class="transition trhover">
            ...
            <td class="flex_ tabing">
                <div class="flex_ tabing_non_justify">
                    <div class="delp border_one transition" id="<?php echo filter_var($postID, FILTER_SANITIZE_STRING);?>"><?php echo filter_var($iN->iN_SelectedMenuIcon('28'), FILTER_SANITIZE_STRING).$LANG['delete'];?></div>
                    <div class="seePost c2 border_one transition" id="<?php echo filter_var($postID, FILTER_SANITIZE_STRING);?>"><a href="<?php echo filter_var($seePostButton, FILTER_SANITIZE_STRING);?>"><?php echo filter_var($iN->iN_SelectedMenuIcon('27'), FILTER_SANITIZE_STRING).$LANG['edit_post'];?></a></div>
                </div>
            </td> 
        </tr>
        <?php }?>
        ...
        <?php }else{echo '<div class="no_creator_f_wrap flex_ tabing"><div class="no_c_icon">'.filter_var($iN->iN_SelectedMenuIcon('54'), FILTER_SANITIZE_STRING).'</div><div class="n_c_t">'.$LANG['no_post_pending_approval'].'</div></div>';}?>             
        </div>
        <!---->

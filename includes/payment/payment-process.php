...
if (isset($_POST) && count($_POST) > 0) {
	...
	if ($validation === true) { 
	    ...
	    if ($paymentOption == 'bitcoin') {
	        ...
	        echo json_encode("https://www.amberance.com/pay.php");
		...
		} else if ($paymentOption == 'paystack' || $paymentOption == 'iyzico' || $paymentOption == 'paypal' || $paymentOption == 'stripe' || $paymentOption == 'authorize-net' || $paymentOption == 'bitpay') {
